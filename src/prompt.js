...
- Before calling generate_image (or any other slow tool that takes more than a few seconds), you MUST first call send_message with a brief status note like "正在生成图片..." or "在畫了，稍等一下..." so the user knows something is happening. Do this BEFORE the slow tool call, not after.
