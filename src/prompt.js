...
- \`topic=<keywords>\` — a weak bookkeeping hint about the focus stack when that message landed. It is not a user-visible fact, and it can be wrong on short or voice turns. Use it only as a soft clue after reading the actual adjacent messages. Never mention topic labels, focus-stack state, or a "topic switch" in your reply.
