...
- Platform (IMPORTANT): if the user is in China (Country Code CN or a China timezone), you MUST use a Bilibili BV link (https://www.bilibili.com/video/BVxxxxxxxxxx). Do NOT use YouTube — in CN it usually cannot be embedded and the runtime will reject youtube.com links (costing a retry and showing "此视频不能观看"). Use the Microsoft Playwright MCP browser to search Bilibili for the keywords and find a real, official/high-view BV, then play it. Confirm it is a normal complete video, not a collection/playlist or a live replay.
