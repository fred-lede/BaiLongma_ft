    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          results: {
            type: 'object',
            description: 'Per-capability result map. Suggested keys: filesystem, dedicated_chrome, hotspot_panel, music_player, focus_banner, ui_card. Each value should include status and detail.',
