...
function mountPersonCardPanel() {
  ...
  const voiceInput = panel.querySelector('#pc-voice-id');
  const cloneBtn = panel.querySelector('#pc-clone-voice-btn');
  const cloneFile = panel.querySelector('#pc-clone-file');
  const testBtn = panel.querySelector('#pc-test-voice-btn');
  const cloneStatus = panel.querySelector('#pc-clone-status');
  const langSelect = panel.querySelector('#pc-language');
